...
export const termsPolicy: PolicyProps[] = [
  ...
  },
  {
    ...
    policyContent: [
      ...
      'You can withdraw your consent or delete your data at any time by contacting <span class="font-semibold">[safe@kyrah.ai]</span>.',
    ],
  },
  {
...
export const privacyPolicy: PolicyProps[] = [
  ...
  },
  {
    ...
    policyContent: [
      ...
      'You may request deletion of your data at any time by contacting us at <span class="font-semibold">[safe@kyrah.ai]</span>.',
    ],
  },
];
...
export const cookiePolicy: PolicyProps[] = [
  ...
  },
  {
    ...
    policyContent: [
      ...
      'For questions about our Cookie Policy, contact us at <span class="font-semibold">[safe@kyrah.ai]</span>.',
    ],
  },
];
