          ...
          <div className="grid grid-cols-12 gap-8 items-center">
            ...
            <div className="col-span-12 md:col-span-3 px-6 md:px-8 xl:px-20 flex items-center gap-1 pt-8 md:pt-0">
              ...
              <div className="flex flex-col text-neutral-9 gap-2 relative">
                ...
                <p className="absolute top-18 md:top-22 md:!left-0 xl:!top-40 xl:!-right-4 font-spectral font-extrabold tracking-[-0.04rem] uppercase text-right whitespace-nowrap">
                  2024 winner
                </p>
              </div>
            </div>
