...
export default function SafetySection() {
  ...
  return (
    <section className="col-span-12 w-full bg-neutral z-[60] pt-7.5 pb-60">
      <div className="w-[87.5%] xl:w-[80%] 2xl:w-[70%] max-w-7xl mx-auto flex flex-col gap-8">
        <div className="flex flex-col gap-2.5 text-neutral-9">
          ...
          <div>
            <div className="heading-28-semi md:!text-[2.5rem] md:!font-medium md:!tracking-[-0.06rem] xl:!text-[3.375rem] xl:!tracking-[-0.06rem]">Stay Safe,</div>
            <div className="heading-28-semi md:!text-[2.5rem] md:!font-medium md:!tracking-[-0.06rem] xl:!text-[3.375rem] xl:!tracking-[-0.06rem]">Stay in Control</div>
          </div>
        </div>
        <div className="w-full flex flex-col gap-8 xl:grid xl:grid-cols-12 items-center">
          {/* Image */}
          ...
          <div className="xl:col-span-6 xl:col-start-7 flex flex-col gap-4 text-neutral-9">
            <div className="body-16-regular md:!text-[1.25rem] md:!leading-[130%] xl:pt-[7.5rem]">
            ...
            <button
              className="body-18-semi w-full rounded-full border border-neutral-9 px-28 py-3.5 mt-14 cursor-pointer"
              onClick={() => {
