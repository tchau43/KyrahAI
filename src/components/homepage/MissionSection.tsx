...
export default function MissionSection() {
  ...
  return (
    <section className="col-span-12 w-full bg-neutral relative pb-40">
      <div className="w-[87.5%] xl:w-[80%] max-w-21xl mx-auto relative">
        ...
        <div className="absolute right-0 top-0 w-[569px] h-[559px]">
