  ...
  return (
    <section className="col-span-12 w-full bg-neutral">
      <div className="w-[87.5%] xl:w-[80%] max-w-21xl mx-auto">
        <div className="w-full grid grid-cols-1 md:grid-cols-12 items-center pt-20 pb-40">
          {/* Left Content */}
          <div className="md:col-start-1 md:col-span-6 flex flex-col gap-8 z-10">
            <div className="flex flex-col gap-8">
              ...
              <div className="flex-col gap-8 grid grid-cols-12">
                <div className="col-span-12 heading-54 text-neutral-9 pb-4">
            ...
            <div className="flex flex-col gap-6 mt-2">
              ...
              <Link
                href="/about"
                className="body-18-semi w-max rounded-full border border-neutral-9 px-28 py-3.5 mt-3 cursor-pointer"
              >
                View more
              </Link>
            </div>
