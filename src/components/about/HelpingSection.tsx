...
export default function HelpingSection() {
  return (
    <section className="col-span-12 w-full bg-primary pt-16 md:pt-20 lg:pt-30 rounded-t-2xl md:rounded-t-3xl pb-16 md:pb-24 lg:pb-[8.5rem] flex justify-center overflow-hidden relative z-3 -mt-4 md:-mt-5 lg:-mt-5 xl:-mt-6">
