export default function SafetyGuideSection() {
  return (
    <section className="col-span-12 w-full bg-neutral pt-35 md:pt-35 xl:pt-40 pb-10 md:pb-14 lg:pb-20 flex justify-center">
      <div className="w-full md:w-[87.5%] xl:w-[80%] px-4 md:px-0">
        <div className="flex flex-col gap-3 md:gap-4 justify-between text-center">
          <div className="body-18-semi text-secondary-1 xl:pt-10">Safety Tips</div>
